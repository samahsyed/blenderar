...
setHTMLElemAttribute('href', 'https://www.playbook.com/s/samah-s/uLhssWSzphmySEdXZGZYXE7h', 'info_button', false);
...
operateAnimation('PLAY', 'sudhi_armature', 0, 180, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 5);
registerOnClick('sudhi_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'sudhi_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'sudhi_armature', 181, 275, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'sudhi_group'], false);
      ...
      changeVis(['GROUP', 'sudhi_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('sudhi_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('sudhi_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('sudhi_mesh'), 'enter_AR_button', false);
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'sudhi_group'], true);
  setObjTransform('sudhi_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('sudhi_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('sudhi_armature', 'XY', 'WORLD', 'CxLVq$mgbUPY}CssQ0iE', '*4o6EC73d:F=Af7mrRBc');
}, function() {}, '*4o6EC73d:F=Af7mrRBc');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('sudhi_armature', 'Z', 'WORLD', ',{HANJ2HF3u!MIgENwV`', 'A4gIAA?4_oRz%D`@c(ZT');
}, function() {}, 'A4gIAA?4_oRz%D`@c(ZT');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('sudhi_armature', 'Z', '^u3*Ol.MF9^3*dbs^@4i', 'Ct,k;${E7{JG1]K,/B%t');
  dragScale('sudhi_armature', 'X', 'XA$zD^6zU*6gAl4EQHb/', 'Ct,k;${E7{JG1]K,/B%t');
  dragScale('sudhi_armature', 'Y', 'M[mtYC{]qbS}01%mXFPP', 'Ct,k;${E7{JG1]K,/B%t');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('sudhi_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'Ct,k;${E7{JG1]K,/B%t');
